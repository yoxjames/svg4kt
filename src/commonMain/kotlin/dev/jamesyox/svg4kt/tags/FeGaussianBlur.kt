...
public data object FeGaussianBlur :
    SvgTag,
 ...
 * [dev.jamesyox.svg4kt.attr.attrs.stdDeviation], which defines the bell-curve.
 *
...
public fun <T> feGaussianBlur(content: context(AttributeConsumer, @SvgTagDSL FeGaussianBlur) () -> Unit): T {
    ...
    return consumeTag(tag = FeGaussianBlur, content = content)
}
