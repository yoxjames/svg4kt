 ...
 *
 * The `<pattern>` is referenced by the [dev.jamesyox.svg4kt.attr.attrs.fill] and/or
 * [dev.jamesyox.svg4kt.attr.attrs.stroke] attributes on other graphics elements to fill or stroke those
