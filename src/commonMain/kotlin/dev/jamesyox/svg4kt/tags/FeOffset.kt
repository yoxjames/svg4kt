 ...
 * The input image as a whole is offset by the values specified in the [dev.jamesyox.svg4kt.attr.attrs.dx]
 * and [dev.jamesyox.svg4kt.attr.attrs.dy] attributes.
 */
...
public fun <T> feOffset(content: context(AttributeConsumer, @SvgTagDSL FeOffset) () -> Unit): T {
    ...
    return consumeTag(tag = FeOffset, content = content)
}
