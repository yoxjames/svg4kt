...
import dev.jamesyox.svg4kt.tags.categories.category.TextContentChildElement
import dev.jamesyox.svg4kt.tags.categories.category.TextContentElement
...
import dev.jamesyox.svg4kt.tags.categories.container.TextContentContainer
 ...
 * in the `<textPath>` element and its [dev.jamesyox.svg4kt.attr.attrs.href] attribute is used to reference the desired
 * [path].
 */
