...
/**
 * The `<switch>` SVG element evaluates any `requiredFeatures`, [dev.jamesyox.svg4kt.attr.attrs.requiredExtensions]
 * and [dev.jamesyox.svg4kt.attr.attrs.systemLanguage] attributes on its direct child elements in order, and then
