 ...
 * So it defines a limiting cone which restricts the region where the light is projected. No light is projected
 * outside the cone.
 */
context(
    ac: AttributeConsumer,
    _: AttributeContainer.LimitingConeAngle
)
public var limitingConeAngle: Number
    @Deprecated(SetOnlyPropertyError, level = DeprecationLevel.ERROR)
    get() = noGet()
    set(value) {
        ac["limitingConeAngle"] = value.svgString
    }
