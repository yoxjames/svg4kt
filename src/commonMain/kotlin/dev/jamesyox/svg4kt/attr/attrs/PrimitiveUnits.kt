...
public enum class PrimitiveUnits(
     ...
     * coordinate system in place at the time when the [dev.jamesyox.svg4kt.tags.Filter] element is referenced
     * (i.e., the user coordinate system for the element referencing the [dev.jamesyox.svg4kt.tags.Filter] element
