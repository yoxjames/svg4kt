...
/**
 * For [LinearGradient], [x2] defines the x coordinate of the ending point of the _gradient vector_ used to map the
...
/**
 * Unsafe version of [x2]. Functionality depends on what [dev.jamesyox.svg4kt.SvgTag] is the parent.
 */
context(
    ac: AttributeConsumer,
