 ...
 *
 * The autofocus attribute has an HTML counterpart: autofocus. No more than one element in the document may have the
 * autofocus attribute. If applied to multiple elements, the first one will receive focus.
 */
context(
